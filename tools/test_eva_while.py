...
from pysot.models.utile_tctplus.model_builder import ModelBuilder_tctrack
from pysot.models.utile_tctrackplus.model_builder import ModelBuilder_tctrackplus
from pysot.tracker.tctplus_tracker import TCTrackTracker
...
from toolkit.datasets import OTBDataset,LaSOTDataset,UAVTrack112Dataset,UAV10Dataset,UAVDataset,DTBDataset,UAVTrack112lDataset
...
parser.add_argument('--tracker_prefix',default='TCTrack', type=str)
...
if __name__ == '__main__':
    num = 41
    while num <=48:
        snapshot_dir = './tools/snapshot/checkpoint00_e%d.pth' % (num)
        main(snapshot_dir)
        num = num + 1